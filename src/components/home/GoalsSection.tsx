      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-6 border border-gray-700 rounded-2xl bg-gray-800">
            <h3 className="text-4xl font-extrabold text-[#768EA6] mb-2">1M+</h3>
            <p className="text-gray-300">Riders Financed</p>
          </div>
          <div className="p-6 border border-gray-700 rounded-2xl bg-gray-800">
            <h3 className="text-4xl font-extrabold text-[#768EA6] mb-2">0%</h3>
            <p className="text-gray-300">Paperwork & Hassle</p>
          </div>
          <div className="p-6 border border-gray-700 rounded-2xl bg-gray-800">
            <h3 className="text-4xl font-extrabold text-[#768EA6] mb-2">100%</h3>
