      ...
      <section className="py-10 md:py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            <div className="p-8 rounded-3xl bg-[#D1DCE2] border border-gray-100 shadow-sm">
              <div className="w-16 h-16 bg-[#768EA6]/20 text-[#9e7146] rounded-full flex items-center justify-center mx-auto mb-6">
                <Target size={32} />
              </div>
